...
public static class Bytes
{
    ...
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static int ToInt(this byte[] value, int position = 0) => BitConverter.ToInt32(value, position);
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static uint ToUInt(this byte[] value, int position = 0) => BitConverter.ToUInt32(value, position);
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static long ToLong(this byte[] value, int position = 0) => BitConverter.ToInt64(value, position);
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static ulong ToULong(this byte[] value, int position = 0) => BitConverter.ToUInt64(value, position);
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static long ToShort(this byte[] value, int position = 0) => BitConverter.ToInt16(value, position);
    /// <summary>
    /// Convert the primitive variable to bytes
    /// </summary>
    /// <param name="value">Variable to get the byte values from</param>
    /// <param name="position">The starting position within value</param>
    /// <returns>Byte array</returns>
    public static ulong ToUShort(this byte[] value, int position = 0) => BitConverter.ToUInt16(value, position);
}
